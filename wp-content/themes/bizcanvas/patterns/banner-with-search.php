<?php
/**
 * Title: Banner With Search
 * Slug: bizcanvas/banner-with-search
 * Categories: bizcanvas
 * Keywords: banner-with-search
 */
?>
<!-- wp:cover {"url":"https://demos.themegrove.com/bizcanvas/wp-content/uploads/sites/35/2024/06/wood-white-texture-floor-pattern-color-1031403-pxhere.com_.jpg","id":200,"dimRatio":90,"overlayColor":"black","isUserOverlayColor":true,"focalPoint":{"x":0.76,"y":0},"minHeight":650,"contentPosition":"top center","metadata":{"name":"Banner"},"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"className":"banner","layout":{"type":"default"}} -->
<div class="wp-block-cover has-custom-content-position is-position-top-center banner" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:650px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-200" alt="" src="https://demos.themegrove.com/bizcanvas/wp-content/uploads/sites/35/2024/06/wood-white-texture-floor-pattern-color-1031403-pxhere.com_.jpg" style="object-position:76% 0%" data-object-fit="cover" data-object-position="76% 0%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"48px"},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white"} -->
...
<p style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30)"><?php echo esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit- et ut massa libero egestas malesuada viverra gravida libero cursus nulla leo pulvinar.', 'bizcanvas' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:search {"label":"","showLabel":false,"placeholder":"Search More","width":75,"widthUnit":"%","buttonText":"Search","buttonPosition":"no-button","buttonUseIcon":true,"style":{"border":{"width":"1px","radius":"8px"},"typography":{"lineHeight":"3.3"}}} /-->
...
<!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"id":276,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/banner.png" alt="" class="wp-image-276"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div></div>
